...
\begin{enumerate}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\linewidth]{Simluations/Experiment_1/figs/component-bar.png}
        \label{fig:placeholder}
    \end{figure}
    \item Modifying DC-Sweep settings,
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\linewidth]{Simluations/Experiment_1/figs/simulate.png}
        \label{fig:placeholder}
    \end{figure}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\linewidth]{Simluations/Experiment_1/figs/run.png}
        \label{fig:placeholder}
    \end{figure}
\end{enumerate}
\subsection{MOSFET}
\begin{enumerate}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Simluations/Experiment_1/figs/mosfet-sweep-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Simluations/Experiment_1/figs/mosfet-sweep-2.png}
  \end{subfigure}
  \label{fig:main}
\end{figure}
...
\begin{enumerate}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Simluations/Experiment_1/figs/bjt-sweep-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Simluations/Experiment_1/figs/bjt-sweep-2.png}
  \end{subfigure}
  \label{fig:main}
\end{figure}
